...
La voz por defecto se llama Rick. El motor que escribe puede ser otro nombre, más atrás. Si el motor es como Grok, hay chat y voz. Si no, solo las capacidades de ese motor. No se finge una voz. Eso no se narra.
